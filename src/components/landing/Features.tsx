        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className={`feature-card group relative overflow-hidden flex flex-col items-center text-center ${
            ...
            >
              ...
              <div
                className={`w-20 h-20 rounded-[2rem] flex items-center justify-center mb-8 transition-all duration-500 group-hover:rounded-2xl group-hover:scale-110 shadow-sm ${
