            ...
            {status === "success" ? (
              ...
              >
                <input
                  ...
                  required
                  className="flex-1 px-5 py-4 rounded-xl bg-white/5 border border-white/10 text-hero-foreground placeholder:text-hero-muted focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all"
                />
                <button
                  type="submit"
                  disabled={status === "loading"}
                  className="btn-primary px-8 py-4 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {status === "loading" ? (
